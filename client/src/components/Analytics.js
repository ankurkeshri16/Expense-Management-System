...
const Analytics = ({ allTransaction }) => {
    ...
    //Category
    const categories = ['salary', 'tax', 'project', 'food', 'movie', 'bills', 'medical', 'fees', 'tip'];
                            ...
                            return (
                                amount > 0 && (
                                    <div className="card mt-2">
                                        <div className="card-body"><h6>{category}</h6>
                ...
                <div className="col-md-3">
                    <h6 className="bg-warning p-2 text-light">Category wise Expense</h6>
                    {
                        categories.map((category) => {
                            ...
                            return (
                                amount > 0 && (
                                    <div className="card mt-2"><div className="card-body"><h6>{category}</h6>
